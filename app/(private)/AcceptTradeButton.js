...
const AcceptTradeButton = ({ ChangeTradeStatus, priority, tradeId, userId, status }) => {
  const ChangeStatus = async () => {
    const response = await ChangeTradeStatus({ tradeId, userId, status: "accepted", priority });

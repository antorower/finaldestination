  ...
  return (
    <PageTransition>
      <div className="flex flex-col gap-4 pb-4">
        ...
        {user.tel && <div className="bg-orange-300 text-white p-4 text-center text-sm font-bold border border-green-700">Κέρδη: $182</div>}
        {user.tel && <div className="bg-orange-300 text-white p-4 text-center text-sm font-bold border border-green-700">Τελευταίο λάθος: -</div>}

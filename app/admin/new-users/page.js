  ...
  return (
    <PageTransition>
      <div className="flex flex-wrap gap-8 justify-center">
        {newUsers.map((user) => {
          return (
            <div className="p-4 bg-gray-100 border w-full max-w-[500px] border-gray-200 rounded-lg text-2xl text-gray-800 font-bold flex flex-col gap-2" key={`new-user-${user._id.toString()}`}>
